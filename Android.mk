...
include $(CLEAR_VARS)
LOCAL_MODULE := smoothedcontroller
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"SmoothedController"' -DVERSION='"1.2.0"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
